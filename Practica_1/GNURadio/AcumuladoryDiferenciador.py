...
import AcumuladoryDiferenciador_epy_block_0 as epy_block_0  # embedded python block
import AcumuladoryDiferenciador_epy_block_1 as epy_block_1  # embedded python block
import sip
import threading



class AcumuladoryDiferenciador(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "AcumuladoryDiferenciador")
...
def main(top_block_cls=AcumuladoryDiferenciador, options=None):
