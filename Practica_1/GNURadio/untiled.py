...
# Title: AcumuladoryDiferenciador
...
import sip
import threading
import untiled_epy_block_0 as epy_block_0  # embedded python block
import untiled_epy_block_1 as epy_block_1  # embedded python block



class untiled(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "AcumuladoryDiferenciador", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("AcumuladoryDiferenciador")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "untiled")
        ...
        self.epy_block_1 = epy_block_1.blk(example_param=)
        self.epy_block_0 = epy_block_0.blk(example_param=1.0)
        self.blocks_vector_source_x_0 = blocks.vector_source_f((-2, -1, 1,0,2), True, 1, [])
        ...
        self.connect((self.blocks_throttle2_0_0, 0), (self.epy_block_1, 0))
...
def main(top_block_cls=untiled, options=None):
