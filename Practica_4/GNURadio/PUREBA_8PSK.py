...
import PUREBA_8PSK_epy_block_0 as epy_block_0  # embedded python block
import PUREBA_8PSK_epy_block_0_0 as epy_block_0_0  # embedded python block
import PUREBA_8PSK_epy_block_0_1 as epy_block_0_1  # embedded python block
import math
import numpy as np
import sip
import threading
...
class PUREBA_8PSK(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "PUREBA_8PSK")
        ...
        self.Menu.addTab(self.Menu_widget_4, "PSD (Watts/Hz)")
        ...
        self.Menu_grid_layout_4.addWidget(self._qtgui_vector_sink_f_0_win, 3, 0, 1, 1)
        for r in range(3, 4):
        ...
        self.Menu_grid_layout_0.addWidget(self._qtgui_time_sink_x_0_1_win, 2, 1, 1, 1)
        for r in range(2, 3):
        ...
        self.fft_vxx_0_0 = fft.fft_vfc(N, True, [1]*N, True, 1)
        ...
        self.blocks_multiply_const_vxx_0_1 = blocks.multiply_const_ff((2*math.pi/m))
        ...
        # Connections
        ##################################################
        self.connect((self.analog_const_source_x_0_0, 0), (self.epy_block_0, 0))
        self.connect((self.analog_const_source_x_0_0, 0), (self.epy_block_0_0, 0))
    ...
    def set_m(self, m):
        ...
        self.blocks_multiply_const_vxx_0_1.set_k((2*math.pi/self.m))
    ...
    def set_N(self, N):
        ...
        self.fft_vxx_0_0.set_window([1]*self.N)
        self.qtgui_vector_sink_f_0.set_x_axis((-self.samp_rate/2), (self.samp_rate/self.N))




def main(top_block_cls=PUREBA_8PSK, options=None):
