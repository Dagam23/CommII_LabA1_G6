...
class PSKup(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "PSKup")
        ...
        # Variables
        ##################################################
        self.tabla_de_verdad_constelacion = tabla_de_verdad_constelacion = (-3-3j,-3-1j,-3+3j,-3+1j,-1-3j,-1-1j,-1+3j,-1+1j,3-3j,3-1j,3+3j,3+1j,1-3j,1-1j,1+3j,1+1j)
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_c(samp_rate_0, analog.GR_SIN_WAVE, 50000, 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate_0, analog.GR_COS_WAVE, 50000, 1, 0, 0)
    ...
    def set_Rs(self, Rs):
        ...
        self.set_Rb(self.Rs*self.bps)
        self.set_samp_rate_0(self.Rs*self.Sps)
        self.qtgui_freq_sink_x_0_0.set_frequency_range(0, self.Rs)
...
def main(top_block_cls=PSKup, options=None):
